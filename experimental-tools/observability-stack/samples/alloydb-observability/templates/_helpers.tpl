...
*/}}
{{- define "alloydb-observability.chart" -}}
...
helm.sh/chart: {{ include "alloydb-observability.chart" . }}
...
*/}}
{{- define "alloydb-observability.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "alloydb-observability.fullname" .) .Values.serviceAccount.name }}
{{- else }}
